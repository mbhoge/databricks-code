...
# MAGIC %md
# MAGIC Create a query that shows the sum of all purchases for each unique email.

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC -- TODO write a simple SQL query that sums purchase_revenue_in_usd for each unique email.
# MAGIC -- Sort the result by the sum from high to low
# MAGIC
# MAGIC SELECT -- TODO
# MAGIC FROM sales_delta
# MAGIC -- TODO
