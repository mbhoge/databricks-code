...
# MAGIC %pip install --upgrade --quiet langchain==0.2.11 langchain-community==0.2.10 langchain-experimental==0.0.64 youtube_search wikipedia==1.4.0 duckduckgo-search==6.2.5 mlflow==2.14.3 pydantic==2.8.2 cloudpickle==2.2.1
# MAGIC
...
# MAGIC %md
# MAGIC ## Save the Agent to Model Registery in UC
# MAGIC
