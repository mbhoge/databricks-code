...
# MAGIC [ADE 3.1 - Follow Along Demo - PII Lookup Table]($./ADE 3.1 - Follow Along Demo - PII Lookup Table) <br>
# MAGIC [ADE 3.2 - Follow Along Demo - Pseudonymized ETL]($./ADE 3.2 - Follow Along Demo - Pseudonymized ETL) <br>
# MAGIC [ADE 3.3 - Follow Along Demo - Deidentified PII Access]($./ADE 3.3 - Follow Along Demo - Deidentified PII Access) <br>
# MAGIC Lecture: Streaming Data and CDF (slides available in .pdf) <br>
# MAGIC Lecture: Deleting Data in the Lakehouse <br>
# MAGIC [ADE 3.4 - Follow Along Demo - Processing Records from CDF]($./ADE 3.4 - Follow Along Demo - Processing Records from CDF) <br>
# MAGIC [ADE 3.5L - Propagating Changes with CDF Lab]($./ADE 3.5L - Propagating Changes with CDF Lab) <br>
# MAGIC [ADE 3.6 - Follow Along Demo - Propagating Deletes with CDF]($./ADE 3.6 - Follow Along Demo - Propagating Deletes with CDF) <br>
# MAGIC
# MAGIC
# MAGIC #### Prerequisites
