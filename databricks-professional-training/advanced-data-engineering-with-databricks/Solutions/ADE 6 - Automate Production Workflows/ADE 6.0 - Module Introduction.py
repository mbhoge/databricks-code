...
# MAGIC [ADE 6.1 - Follow Along Demo - Generate Tokens]($./ADE 6.1 - Follow Along Demo - Generate Tokens) <br>
# MAGIC [ADE 6.2 - Follow Along Demo - Using the Databricks CLI]($./ADE 6.2 - Follow Along Demo - Using the Databricks CLI) <br>
# MAGIC Lecture: Batch and Streaming Jobs <br>
# MAGIC [ADE 6.3 - Follow Along Demo - Using the Databricks API]($./ADE 6.3 - Follow Along Demo - Using the Databricks API) <br>
# MAGIC [ADE 6.4 - Follow Along Demo - Deploy a Pipeline with the CLI]($./ADE 6.4 - Follow Along Demo - Deploy a Pipeline with the CLI) <br>
