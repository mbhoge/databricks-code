...
# MAGIC [ADE 5.2 - Follow Along Demo - Modularize Code]($./ADE 5.2 - Follow Along Demo - Modularize Code) <br>
# MAGIC [ADE 5.3 - Follow Along Demo - Develop Pipelines]($./ADE 5.3 - Follow Along Demo - Develop Pipelines) <br>
# MAGIC [ADE 5.4 - Follow Along Demo - Unit Test Pipelines]($./ADE 5.4 - Follow Along Demo - Unit Test Pipelines) <br>
# MAGIC [ADE 5.5 - Follow Along Demo - Monitor Data Quality]($./ADE 5.5 - Follow Along Demo - Monitor Data Quality) <br>
