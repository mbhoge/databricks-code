...
# MAGIC [ADE 2.1 - Follow Along Demo: Auto Load to Bronze]($./ADE 2.1 - Follow Along Demo - Auto Load to Bronze) <br>
# MAGIC [ADE 2.2 - Follow Along Demo: Stream from Multiplex Bronze]($./ADE 2.2 - Follow Along Demo - Stream from Multiplex Bronze) <br>
# MAGIC Lecture: Data Quality Enforcement Patterns (slides available in .pdf) <br>
# MAGIC [ADE 2.3 - Follow Along Demo: Data Quality Enforcement]($./ADE 2.3 - Follow Along Demo - Data Quality Enforcement) <br>
# MAGIC [ADE 2.4L - Streaming ETL Lab]($./ADE 2.4L - Streaming ETL Lab) <br>
# MAGIC Lecture: Data Modeling (slides available in .pdf) <br>
# MAGIC [ADE 2.5 - Follow Along Demo: Data Modeling: SCD Type 2]($./ADE 2.5 - Follow Along Demo - Data Modeling - SCD Type 2) <br>
# MAGIC Lecture: Streaming Joins and Statefulness (slides available in .pdf) <br>
# MAGIC [ADE 2.6 - Follow Along Demo: Streaming Joins]($./ADE 2.6 - Follow Along Demo - Streaming Joins) <br>
# MAGIC
# MAGIC
# MAGIC #### Prerequisites
